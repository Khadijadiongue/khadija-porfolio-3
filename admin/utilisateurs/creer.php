...
<head>
    ...
    <title>Créer un Admin | Espace Privé</title>
            ...
            <form action="creer.php" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="prenom" name="prenom" placeholder="Ex: Khadidiatou" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="nom">Nom *</label>
                        <input type="text" id="nom" name="nom" placeholder="Ex: Diongue" required>
                    </div>
                </div>
                ...
                <button type="submit" class="btn-submit">
                    <i class="fa-solid fa-user-plus"></i> Enregistrer le compte
                </button>
            </form>
        </div>
    </main>
